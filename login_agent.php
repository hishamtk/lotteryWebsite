        ...
        <div class="container">
          <div class="row">
            ...
            <div class="btn-group btn-group-justified" role="group" aria-label="...">
              ...
              <form method="post" action="login_agent_action.php">
                <div class="form-group">
                  <label for="">Username</label>
                  <input type="text" class="form-control" id="" placeholder="Username" name="id" required>
                </div>
                <div class="form-group">
                  <label for="">Password</label>
                  <input type="password" class="form-control" id="" placeholder="Password" name="pass" required>
                </div> 
                <button type="submit" class="btn btn-default main-color-bg btn-login col-md-4 col-md-offset-4">Let me in !</button>
              </form>
              <div class="btn-group btn-group-justified" role="group" aria-label="...">
                <div class="btn-group" role="group">
